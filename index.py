...
def d_dtcn():
	...
	root.title("DROWSINESS AND YAWN DETECTION")
	Label(root, text="DROWSINESS AND YAWN DETECTION",font=("times new roman",20),fg="black",bg="aqua",height=2).grid(row=2,rowspan=2,columnspan=5,sticky=N+E+W+S,padx=5,pady=10)
